---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-tf-autoscaler | REPORT-2024-04-07
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <div class="firstResponsePRCrop">
      <figure>
        <img alt="firstResponseForClosedPR" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-autoscaler/firstResponseForClosedPR_batcave-tf-autoscaler_data.png" | url }}" />
      </figure>
    </div>
    <!--- Line Complexity Graphs -->
    <h3>Line Complexity</h3>
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-autoscaler/total_line_makeup_batcave-tf-autoscaler_data.svg" | url }}" />
    </figure>
  </div>
</div>