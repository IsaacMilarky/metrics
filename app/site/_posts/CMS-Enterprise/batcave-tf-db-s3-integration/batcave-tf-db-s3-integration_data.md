---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-tf-db-s3-integration | REPORT-2024-03-22
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <div class="firstResponsePRCrop">
      <figure>
        <img alt="firstResponseForClosedPR" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-db-s3-integration/firstResponseForClosedPR_batcave-tf-db-s3-integration_data.png" | url }}" />
      </figure>
    </div>
    <!--- Line Complexity Graphs -->
    <h3>Line Complexity</h3>
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-db-s3-integration/total_line_makeup_batcave-tf-db-s3-integration_data.svg" | url }}" />
    </figure>
  </div>
</div>