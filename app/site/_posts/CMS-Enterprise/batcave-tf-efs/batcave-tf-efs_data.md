---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-tf-efs | REPORT-2024-03-24
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-efs/issue_gauge_batcave-tf-efs_data.svg" | url }}" />
    </figure>
    <!--- Contributor Activity Line Graph -->
    <h3>Commits by Month</h3>
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-efs/commit_sparklines_batcave-tf-efs_data.svg" | url }}" />
    </figure>
