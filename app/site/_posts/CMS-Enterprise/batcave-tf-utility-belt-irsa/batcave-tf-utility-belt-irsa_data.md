---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-tf-utility-belt-irsa | REPORT-2024-04-07
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-utility-belt-irsa/total_line_makeup_batcave-tf-utility-belt-irsa_data.svg" | url }}" />
    </figure>
  </div>
</div>