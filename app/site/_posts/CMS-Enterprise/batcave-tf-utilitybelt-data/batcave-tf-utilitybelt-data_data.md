---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-tf-utilitybelt-data | REPORT-2024-03-24
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-utilitybelt-data/issue_gauge_batcave-tf-utilitybelt-data_data.svg" | url }}" />
    </figure>
    <!--- Contributor Activity Line Graph -->
    <h3>Commits by Month</h3>
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-tf-utilitybelt-data/commit_sparklines_batcave-tf-utilitybelt-data_data.svg" | url }}" />
    </figure>
