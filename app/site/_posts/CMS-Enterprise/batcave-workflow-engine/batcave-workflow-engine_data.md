---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-workflow-engine | REPORT-2024-03-22
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/batcave-workflow-engine/total_line_makeup_batcave-workflow-engine_data.svg" | url }}" />
    </figure>
  </div>
</div>