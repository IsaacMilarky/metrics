---
layout: repo-report
title: Open Source at CMS Metrics Report for cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay | REPORT-2024-03-24
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay/issue_gauge_cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay_data.svg" | url }}" />
    </figure>
    ...
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/CMS-Enterprise/cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay/total_line_makeup_cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay_data.svg" | url }}" />
    </figure>
  </div>
</div>