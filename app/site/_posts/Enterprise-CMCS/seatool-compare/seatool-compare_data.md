---
layout: repo-report
title: Open Source at CMS Metrics Report for seatool-compare | REPORT-2024-03-24
...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <div class="firstResponsePRCrop">
      <figure>
        <img alt="firstResponseForClosedPR" src="{{ "/assets/img/graphs/Enterprise-CMCS/seatool-compare/firstResponseForClosedPR_seatool-compare_data.png" | url }}" />
      </figure>
    </div>
    <!--- Line Complexity Graphs -->
    <h3>Line Complexity</h3>
    <figure>
      <embed type="image/svg+xml" src="{{ "/assets/img/graphs/Enterprise-CMCS/seatool-compare/total_line_makeup_seatool-compare_data.svg" | url }}" />
    </figure>
  </div>
</div>