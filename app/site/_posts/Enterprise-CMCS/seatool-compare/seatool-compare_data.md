---
layout: repo-report
title: Open Source at CMS Metrics Report for seatool-compare | REPORT-2024-12-01
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section"  baseurl: site.baseurl, path: "/Enterprise-CMCS/seatool-compare/issue_gauge_seatool-compare_data.svg", title: "Issues & PRs Status Breakdown" %}
    <!--- Contributor Activity Line Graph -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/seatool-compare/commit_sparklines_seatool-compare_data.svg", title: "Commits by Month" %}
    <!--- First Response For Closed PR Scatterplot -->
    {% render "graph-section" baseurl: site.baseurl, class: "firstResponsePRCrop", path: "/Enterprise-CMCS/seatool-compare/firstResponseForClosedPR_seatool-compare_data.png", title: "First Response For Closed PR" %}
    <!--- Line Complexity Graphs -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/seatool-compare/total_line_makeup_seatool-compare_data.svg", title: "Line Complexity" %}
